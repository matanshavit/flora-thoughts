...
const currentUserRole = await fetchQuery(api.currentUser.queries.currentUserRole, {}, convexAuth);
...
export function canEditProject(currentUserRole: UserRoleEnum | undefined, isOwner: boolean) {
